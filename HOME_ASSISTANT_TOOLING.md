...
- Integration domain: `patchpilot`
- Integration path: `custom_components/patchpilot`
...
python3 -m json.tool custom_components/patchpilot/manifest.json >/tmp/patchpilot_manifest_check.json
python3 -m json.tool custom_components/patchpilot/strings.json >/tmp/patchpilot_strings_check.json
python3 -c 'import yaml, pathlib; yaml.safe_load(pathlib.Path("custom_components/patchpilot/services.yaml").read_text())'
```
...
`custom_components/patchpilot/update_logic.py`.
